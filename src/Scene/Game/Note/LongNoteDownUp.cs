...
public class LongNoteDownUp : NortAbstract
{
    enum State
    {
        DOWN,
    ...
    GameObject tape;
    GameObject endNort;
    GameObject directionDown;
    GameObject directionUp;
    ...
    public void SetType(int type)
    {
        ...
        directionDown = startNort.transform.Find("direction").gameObject;
        directionUp = endNort.transform.Find("direction").gameObject;
        switch (type)
        {
            case 0:
                break;
            case 1:
                directionUp.transform.Rotate(new Vector3(0f, 0f, -30f));
                directionUp.transform.Translate(new Vector3(0.2f, 0.1f, 0f));
                break;
            case 2:
                directionUp.transform.Rotate(new Vector3(0f, 0f, 30f));
                directionUp.transform.Translate(new Vector3(-0.2f, 0.1f, 0f));
                break;
            case 3:
                directionDown.transform.Rotate(new Vector3(0f, 0f, 30f));
                directionDown.transform.Translate(new Vector3(-0.2f, 0.1f, 0f));
                break;
            case 4:
                directionDown.transform.Rotate(new Vector3(0f, 0f, 30f));
                directionDown.transform.Translate(new Vector3(-0.2f, 0.1f, 0f));
